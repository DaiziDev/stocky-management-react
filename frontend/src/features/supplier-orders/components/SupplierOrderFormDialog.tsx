...
import { useCreateSupplierOrder } from "../hooks";
import { SupplierOrderSchema, type SupplierOrderFormData } from "../schemas";

const initialValues: SupplierOrderFormData = {
  supplierId: "",
...
export function SupplierOrderFormDialog({
  ...
  return (
    <FormDialog<SupplierOrderFormData>
      open={open}
      onClose={onClose}
      title={t("createTitle")}
...
function SupplierOrderFormBody({
  control,
  supplierOptions,
  articleOptions,
}: {
  control: Control<SupplierOrderFormData>;
        ...
        <div className="space-y-3">
          {fields.map((field, index) => (
            ...
            >
              <SelectField
                name={
                  `lines.${index}.articleId` as FieldPath<SupplierOrderFormData>
                }
                control={control}
              ...
              <NumberField
                name={
                  `lines.${index}.quantity` as FieldPath<SupplierOrderFormData>
                }
                control={control}
